"""STUB MVP — limpar_react. Substituir por skill real em v1.1+."""
import argparse
import json
import shutil
import sys
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(description="STUB skill limpar_react (MVP placeholder)")
    ...
    print(f"OK (stub): limpar_react → {out}", file=sys.stderr)
    return 0
