"""STUB MVP — viral_score. Substituir por skill real em v1.1+."""
import argparse
import json
import shutil
import sys
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(description="STUB skill viral_score (MVP placeholder)")
    ...
    print(f"OK (stub): viral_score → {out}", file=sys.stderr)
    return 0
