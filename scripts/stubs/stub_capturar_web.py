"""STUB MVP — capturar_web. Substituir por skill real em v1.1+."""
import argparse
import json
import shutil
import sys
...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(description="STUB skill capturar_web (MVP placeholder)")
    ...
    print(f"OK (stub): capturar_web → {out}", file=sys.stderr)
    return 0
